...
from model.util.mobile import Mobile, hswish, MobileDown
from model.util.former import Former
from model.util.bridge import Mobile2Former, Former2Mobile
from model.util.config import config_294, config_508, config_52
...
def MobileFormer_508():
    return MobileFormer(config_508)
